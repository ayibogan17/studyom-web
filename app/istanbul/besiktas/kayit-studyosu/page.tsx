...
export const metadata: Metadata = {
  title: "Beşiktaş kayıt stüdyoları | Studyom",
  description:
    "Beşiktaş’ta kayıt için stüdyo arıyorsan doğru yerdesin. İlçe ve kayıt kabini tercihlerine göre filtreleyip Studyom listelerinden uygun stüdyoları keşfedebilirsin.",
  alternates: {
    canonical: "https://www.studyom.net/istanbul/besiktas/kayit-studyosu",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    description:
      "Beşiktaş’ta kayıt için stüdyo arıyorsan doğru yerdesin. İlçe ve kayıt kabini tercihlerine göre filtreleyip Studyom listelerinden uygun stüdyoları keşfedebilirsin.",
    url: "https://www.studyom.net/istanbul/besiktas/kayit-studyosu",
  },
};

export default async function BesiktasRecordingStudiosPage() {
      ...
      <Section className="pt-8 md:pt-12">
        <div className="space-y-3">
          ...
          <h1 className="text-2xl font-semibold text-[var(--color-primary)] md:text-3xl">
            Beşiktaş kayıt stüdyoları
          </h1>
          <p className="max-w-2xl text-sm text-[var(--color-muted)] md:text-base">
            Beşiktaş’ta kayıt için stüdyo arıyorsan doğru yerdesin. İlçe ve kayıt kabini tercihlerine göre filtreleyip
