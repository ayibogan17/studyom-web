...
export const metadata: Metadata = {
  title: "Kadıköy prova stüdyoları | Studyom",
  description:
    "Kadıköy’de prova için stüdyo arıyorsan doğru yerdesin. İlçe, oda türü ve ihtiyaçlarına göre filtreleyip Studyom listelerinden uygun stüdyoları keşfedebilirsin.",
  alternates: {
    canonical: "https://www.studyom.net/istanbul/kadikoy/prova-studyosu",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    description:
      "Kadıköy’de prova için stüdyo arıyorsan doğru yerdesin. İlçe, oda türü ve ihtiyaçlarına göre filtreleyip Studyom listelerinden uygun stüdyoları keşfedebilirsin.",
    url: "https://www.studyom.net/istanbul/kadikoy/prova-studyosu",
  },
};

export default async function KadikoyRehearsalStudiosPage() {
      ...
      <Section className="pt-8 md:pt-12">
        <div className="space-y-3">
          ...
          <h1 className="text-2xl font-semibold text-[var(--color-primary)] md:text-3xl">
            Kadıköy prova stüdyoları
          </h1>
          <p className="max-w-2xl text-sm text-[var(--color-muted)] md:text-base">
            Kadıköy’de prova için stüdyo arıyorsan doğru yerdesin. İlçe, oda türü ve ihtiyaçlarına göre filtreleyip
