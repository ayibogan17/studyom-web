...
export const metadata: Metadata = {
  title: "İzmir prova stüdyoları | Studyom",
  description:
    "İzmir’de prova için stüdyo arıyorsan doğru yerdesin. Konum ve ekipmana göre filtreleyip sana uygun prova stüdyolarını hızlıca keşfedebilirsin.",
  alternates: {
    canonical: "https://www.studyom.net/izmir/prova-studyosu",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    description:
      "İzmir’de prova için stüdyo arıyorsan doğru yerdesin. Konum ve ekipmana göre filtreleyip sana uygun prova stüdyolarını hızlıca keşfedebilirsin.",
    url: "https://www.studyom.net/izmir/prova-studyosu",
  },
};

export default async function IzmirRehearsalStudiosPage() {
      ...
      <Section className="pt-8 md:pt-12">
        <div className="space-y-3">
          ...
          <p className="max-w-2xl text-sm text-[var(--color-muted)] md:text-base">
            İzmir’de prova için stüdyo arıyorsan doğru yerdesin. Konum ve ekipmana göre filtreleyip sana uygun prova
