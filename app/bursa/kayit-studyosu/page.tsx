...
export const metadata: Metadata = {
  title: "Bursa kayıt stüdyoları | Studyom",
  description:
    "Bursa’da kayıt için stüdyo arıyorsan doğru yerdesin. Kayıt kabini, ekipman ve konuma göre filtreleyip sana uygun stüdyoları hızlıca keşfedebilirsin.",
  alternates: {
    canonical: "https://www.studyom.net/bursa/kayit-studyosu",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    description:
      "Bursa’da kayıt için stüdyo arıyorsan doğru yerdesin. Kayıt kabini, ekipman ve konuma göre filtreleyip sana uygun stüdyoları hızlıca keşfedebilirsin.",
    url: "https://www.studyom.net/bursa/kayit-studyosu",
  },
};

export default async function BursaRecordingStudiosPage() {
      ...
      <Section className="pt-8 md:pt-12">
        <div className="space-y-3">
          ...
          <h1 className="text-2xl font-semibold text-[var(--color-primary)] md:text-3xl">
            Bursa kayıt stüdyoları
          </h1>
          <p className="max-w-2xl text-sm text-[var(--color-muted)] md:text-base">
            Bursa’da kayıt için stüdyo arıyorsan doğru yerdesin. Kayıt kabini, ekipman ve konuma göre filtreleyip sana
