...
export const metadata: Metadata = {
  title: "Gaziantep prova stüdyoları | Studyom",
  description:
    "Gaziantep’te prova için stüdyo arıyorsan doğru yerdesin. Konum ve ekipmana göre filtreleyip Studyom listelerinden sana uygun prova stüdyolarını hızlıca keşfedebilirsin.",
  alternates: {
    canonical: "https://www.studyom.net/gaziantep/prova-studyosu",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    description:
      "Gaziantep’te prova için stüdyo arıyorsan doğru yerdesin. Konum ve ekipmana göre filtreleyip Studyom listelerinden sana uygun prova stüdyolarını hızlıca keşfedebilirsin.",
    url: "https://www.studyom.net/gaziantep/prova-studyosu",
  },
};

export default async function GaziantepRehearsalStudiosPage() {
      ...
      <Section className="pt-8 md:pt-12">
        <div className="space-y-3">
          ...
          <h1 className="text-2xl font-semibold text-[var(--color-primary)] md:text-3xl">
            Gaziantep prova stüdyoları
          </h1>
          <p className="max-w-2xl text-sm text-[var(--color-muted)] md:text-base">
            Gaziantep’te prova için stüdyo arıyorsan doğru yerdesin. Konum ve ekipmana göre filtreleyip Studyom
