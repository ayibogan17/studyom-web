...
export const metadata: Metadata = {
  title: "Konya kayıt stüdyoları | Studyom",
  description:
    "Konya’da kayıt için stüdyo arıyorsan doğru yerdesin. Kayıt kabini ve konuma göre filtreleyip Studyom listelerinden sana uygun stüdyoları hızlıca keşfedebilirsin.",
  alternates: {
    canonical: "https://www.studyom.net/konya/kayit-studyosu",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    description:
      "Konya’da kayıt için stüdyo arıyorsan doğru yerdesin. Kayıt kabini ve konuma göre filtreleyip Studyom listelerinden sana uygun stüdyoları hızlıca keşfedebilirsin.",
    url: "https://www.studyom.net/konya/kayit-studyosu",
  },
};
    ...
    <div className="min-h-screen bg-[var(--color-secondary)]">
      <Section className="pt-8 md:pt-12">
        <div className="space-y-3">
          ...
          <h1 className="text-2xl font-semibold text-[var(--color-primary)] md:text-3xl">Konya kayıt stüdyoları</h1>
          <p className="max-w-2xl text-sm text-[var(--color-muted)] md:text-base">
            Konya’da kayıt için stüdyo arıyorsan doğru yerdesin. Kayıt kabini ve konuma göre filtreleyip Studyom
