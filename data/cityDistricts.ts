export const cityDistricts: Record<string, string[]> = {
  ...
  Kırıkkale: ["Merkez", "Bahşılı", "Bala", "Delice", "Karakeçili", "Keskin", "Sulakyurt", "Yahşihan"],
  ...
  Kocaeli: ["Başiskele", "Çayırova", "Darıca", "Derince", "Dilovası", "Gebze", "Gölcük", "İzmit", "Kandıra", "Kartepe", "Karamürsel", "Körfez"],
  Konya: [
    "Ahırlı",
    "Akören",
    "Akşehir",
